...
dnl
dnl @version $Id: acinclude.m4,v 1.1.1.1 2003/10/04 18:00:06 mechnich Exp $
...
[
  ...
  AC_ARG_WITH([Qt-dir],
    [  --with-Qt-dir=DIR       DIR is equal to \$QTDIR if you have followed the
                          ...
                          (default is $QTDIR)],
    ,[with_Qt_dir=$QTDIR])  # kg: added default parameter
...
EOF
      ...
      if test x"$bnv_err_1" != x; then
        ...
        if test x"$bnv_err_2" != x; then
          ...
          if test x"$bnv_err_3" != x; then
            ...
            bnv_err_4=`grep -v '^ *+' bnv_qt_test_4.out | grep -v 'Info:'`  # kg: dirty workaround for auto-import
    ...
    rm -f bnv_qt_test.h moc_bnv_qt_test.$ac_ext moc_bnv_qt_test.o \
          bnv_qt_main.$ac_ext bnv_qt_main.o bnv_qt_main bnv_qt_main.exe \
